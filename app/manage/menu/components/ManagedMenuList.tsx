...
export default function ManagedMenuList() {
  ...
  }, [isLoading, showSkeleton, Menu, activeCategory, sortedCategories]);
                  ...
                  <div className="space-y-4">
                    {menus.map((menu) => (
                      <div
                        ...
                        className="bg-white" // 카드 자체를 bg-white로
                      >
                        <div className="p-6">
                          {menu.onSale ? (
                            <div className="text-blue-700 text-sm font-semibold inline-block">
                              판매중
                            </div>
                          ) : (
                            <div className="text-red-700 text-sm font-semibold inline-block">
                              품절
                            </div>
                          )}
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-[320px] shadow-2xl text-center">
            <h2 className="text-base font-bold text-[#2a2a2a] mb-4">
              정말 {confirmModalData.oldName}을(를) {confirmModalData.newName}로
              변경하시겠습니까?
            </h2>
